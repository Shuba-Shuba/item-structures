...
execute if score bytes commands matches ..999 run return run tellraw @s ["structure data size: ",{score:{name:"bytes",objective:"commands"}}," B"]
...
tellraw @s ["structure data size: ",{score:{name:"kB",objective:"commands"}},".",{score:{name:"bytes",objective:"commands"}}," kB"]
